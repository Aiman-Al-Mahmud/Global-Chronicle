        ...
        <div class="sidebar-inner">
            ...
            <ul class="sidebar-menu scrollable pos-r">
                <li class="nav-item mT-30 active">
                    <a class="sidebar-link" href="{{route('admin.dashboard.main')}}" default>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li>
                            <a class="sidebar-link" href="{{route('admin.news.index')}}">News List</a>
                        </li>
                        <li>
                            <a class="sidebar-link" href="{{route('admin.manage.news')}}">Pulling</a>
                        </li>
                        <li>
                            <a class="sidebar-link" href="{{route('admin.rss.index')}}">Rss Sources</a>
                        </li>
                    </ul>
                </li>
                {{--<li class="nav-item">--}}
                    {{--<a class="sidebar-link" href="{{route('admin.rss.index')}}">--}}
                            {{--<span class="icon-holder">--}}
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li>
                            <a class="sidebar-link" href="{{url('/admin/pages')}}">Pages</a>
                        </li>
                        <li>
                ...
                <li class="nav-item">
                    <a class="sidebar-link" href="{{route('admin.advertisements.index')}}">
                            <span class="icon-holder">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li>
                            <a class="sidebar-link" href="{{route('admin.users.create')}}">Add User</a>
                        </li>
                    </ul>
                </li>
                ...
                <ul class="nav-right">
                                ...
                                <ul class="ovY-a pos-r scrollable lis-n p-0 m-0 fsz-sm">
                                        ...
                                        <a href="#" class="peers fxw-nw td-n p-20 bdB c-grey-800 cH-blue bgcH-grey-100">
                                            <div class="peer mR-15">
                                                <img class="w-3r bdrs-50p"
                                                     src="../../../randomuser.me/api/portraits/men/1.jpg" alt="">
                                            </div>
                                            <div class="peer peer-greed">
                                                    <span>
                                    ...
                                    <li>
                                        <a href="#" class="peers fxw-nw td-n p-20 bdB c-grey-800 cH-blue bgcH-grey-100">
                                            <div class="peer mR-15">
                                                <img class="w-3r bdrs-50p"
                                                     src="../../../randomuser.me/api/portraits/men/2.jpg" alt="">
                                            </div>
                                            <div class="peer peer-greed">
                                                    <span>
                                    ...
                                    <li>
                                        <a href="#" class="peers fxw-nw td-n p-20 bdB c-grey-800 cH-blue bgcH-grey-100">
                                            <div class="peer mR-15">
                                                <img class="w-3r bdrs-50p"
                                                     src="../../../randomuser.me/api/portraits/men/3.jpg" alt="">
                                            </div>
                                            <div class="peer peer-greed">
                                                    <span>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu fsz-sm">
                            <li>
                                <a href="{{route('admin.settings.index')}}" class="d-b td-n pY-5 bgcH-grey-100 c-grey-700">
