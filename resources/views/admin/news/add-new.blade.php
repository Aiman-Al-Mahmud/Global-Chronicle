                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                <select class="form-control" data-placeholder="Select Tags" multiple
                                                    ...
                                                    @if(isset($tags[0]))
                                                        @foreach($tags as $tag)
                                                            <option @if(!empty($news_tags[0]) && in_array($tag,$news_tags)) selected
                                                                    @endif value="{{$tag->id}}">{{$tag->tag_title}}</option>
                                                        @endforeach
                                                    @endif
                                                </select>
                                            </div>
                                            <div class="col-sm-3">
                                                ...
                                                <div class="">
                                                    <input type="checkbox" name="is_featured" id="checkbox_featured"
                                                           @if($news->is_featured == 1) checked
                                                           @endif class="filled-in chk-col-light-blue"/>
        ...
        <div class="modal-dialog modal-lg" style="max-width: 90% !important;" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="text-center hidden" id="loading"><img src="{{asset('admin/loading.gif')}}"
